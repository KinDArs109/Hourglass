...
public partial class MainWindow : Window
{
    ...
    // Installers asking every window to close are turned away by SessionEndGuard, which
    // covers this window along with the hidden ones — a refusal from only one of them
    // was what let a night of idling end at somebody else's update.
